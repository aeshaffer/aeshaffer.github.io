...
function loadCanvas(dataURL) {
    ...
    imageObj.onload = function () {
        ...
        */
        ...
        imagecontext.clip();
        imagecontext.drawImage(this, (dim - that.width) / 2, (dim - that.height) / 2, that.width, that.height);
        // Undo the clipping
...
function setupImageWarp(bpwidget) {
...
//# sourceMappingURL=imagewarp.js.map