...
function workerRainbow(rainbowworker, bprpip, N, cvangles) {
    ...
    rainbowworker.postMessage({ rainbowidata: N,
        cvangles: cvangles,
        bprpip: bprpip
    });
}
function workerRegions(regionsworker, bprpip, N, cvangles) {
    ...
    regionsworker.postMessage({ regionsidata: N,
        cvangles: cvangles,
        bprpip: bprpip
    });
}
...
function showRegions(idata, zs, bpzs, cvangles, rowcallback) {
    return mapOverbpzs(idata, zs, bpzs, function (z, bpz) { return region(cvangles, bpz); }, rowcallback);
}
...
//# sourceMappingURL=bpgraphics.js.map