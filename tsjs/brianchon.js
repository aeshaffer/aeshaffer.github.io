...
var cptAndCoordinate = (function () {
    function cptAndCoordinate() {
    }
    return cptAndCoordinate;
}());
var cptCoordinates;
function displayPoints() {
    var locs = getLocations();
    cptCoordinates = $(".cpt").toArray().map(function (e) {
        return { cpt: e, coords: elementToC($(e)) };
    });
    console.log(cptCoordinates);
    try {
...
$(function () {
    ...
    var r = new ranges({ minX: -1, maxX: 1, minY: -1, maxY: 1 });
    $(window).on('resize', function () {
        cptCoordinates.forEach(function (cptancoord) {
            $(cptancoord.cpt).css(cToPosition2(cptancoord.coords));
        });
