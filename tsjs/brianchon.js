...
var Brianchon;
(function (Brianchon) {
    var BrianchonExample = /** @class */ (function () {
        function BrianchonExample() {
        }
        return BrianchonExample;
    }());
    Brianchon.example0x = {
    ...
    Brianchon.example0 = {
        "A": xy2c(Brianchon.example0x.A),
        "B": xy2c(Brianchon.example0x.B),
        "C": xy2c(Brianchon.example0x.C),
        "D": xy2c(Brianchon.example0x.D),
        "E": xy2c(Brianchon.example0x.E),
        "F": xy2c(Brianchon.example0x.F),
        "F0": xy2c(Brianchon.example0x.F0),
        "F1": xy2c(Brianchon.example0x.F1),
        "P": xy2c(Brianchon.example0x.P)
    };
    ...
    var example1 = canonicalizeExample(Brianchon.example0);
    var ptLabels = ["A", "B", "C", "D", "E", "F"];
    function loadExample(example) {
        Brianchon.cptCoordinates = example;
    ...
    Brianchon.loadExample = loadExample;
    ...
    function displayPoints() {
        Brianchon.cptCoordinates = getLocations();
        calcEllipse();
    }
    function calcEllipse() {
        try {
            ei = ellipseFromFociAndPoint(Brianchon.cptCoordinates.F0, Brianchon.cptCoordinates.F1, Brianchon.cptCoordinates.P);
        }
        catch (ex) {
            ei = null;
            console.log(ex);
    ...
    var TangentsInfo = /** @class */ (function () {
    ...
    Brianchon.findTangent = findTangent;
    ...
    function setup() {
        ...
        $(window).on('resize', function () {
            resizeCanvas();
            loadExample(Brianchon.cptCoordinates);
            displayPoints();
        });
...
$(Brianchon.setup);
//# sourceMappingURL=brianchon.js.map