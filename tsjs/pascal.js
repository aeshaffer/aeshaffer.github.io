...
(function (Pascal) {
    ...
    Pascal.loadExample = loadExample;
    Pascal.outsideExample = {
    ...
    var PascalExample = /** @class */ (function () {
        function PascalExample() {
        }
        return PascalExample;
    }());
    var LeftMiddleRight;
    ...
    function setup() {
        ...
        $("#outsideexample").on("click", function () { loadExample(Pascal.outsideExample); });
        $("#circleexample").on("click", function () { loadExample(Pascal.circleExample); });
