...
(function (CircleInversion) {
    ...
    function circleThrough(z1, z2, z3) {
        ...
        var center = lineLineIntersectionZD(mpz1z2, z1z2perpdirection, mpz2z3, z2z3perpdirection);
    ...
    function lineCircle(color, pt, dir0, ctx) {
        ...
        ctx.beginPath();
        ctx.strokeStyle = color;
        ctx.arc(invCircle.center.x, invCircle.center.y, invCircle.radius, 0, 2 * Math.PI, false);
        ctx.stroke();
    }
    function invertCircle(color, center, radius, ctx) {
        ctx.beginPath();
        ctx.strokeStyle = color;
...
})(CircleInversion || (CircleInversion = {}));
