...
var cvcanvas: HTMLCanvasElement;
var cvcanvascontext: CanvasRenderingContext2D;
var idWhite: ImageData;
var idBlack: ImageData;
$(function () {
    cvcanvas = <HTMLCanvasElement>$("#cvcanvas")[0];
...
function initTexturesFile(durl: string) {
    ...
    cubeImage.onload = function () {
        ...
        var squarecanvas = <HTMLCanvasElement>document.getElementById('squarecanvas');
        var sourcecanvas = <HTMLCanvasElement>document.getElementById('sourcecanvas');
