...
$(function() {
    $("#go").on("click", function() {
        ...
        var outzs = new Array<Array<C>>();
        var automorphism = z => t2c(phi).mul(a.sub(z)).div(none.sub(a.conj().mul(z)));
        var automorphisminv = z => t2c(-phi).mul(automorphism(t2c(-phi).mul(z)));
