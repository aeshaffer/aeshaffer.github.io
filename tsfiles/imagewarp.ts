...
function loadCanvas(dataURL) {
	...
	imageObj.onload = function () {
		var that = <HTMLImageElement>this;
		var dim = Math.min(that.height, that.width);
		...
		*/
		...
		imagecontext.drawImage(this, (dim - that.width) / 2, (dim - that.height) / 2,
...
function setupImageWarp(bpwidget: BPWidget) {
	...
	$("#goupload").click(function () {
		var uploadFile = <HTMLInputElement>$("#uploadfile")[0];
