...
function resizeAndCopy(mine: HTMLCanvasElement, openers: HTMLCanvasElement) {
...
function composeScreenshot(rainbow: HTMLCanvasElement, lines: HTMLCanvasElement,
	ss: HTMLCanvasElement, mylines: HTMLCanvasElement, myrainbow: HTMLCanvasElement, 
	bpwidget: BPWidget): string {
...
function screenshot() {
	if (!parent.window.opener) {
		...
		var mylines = <HTMLCanvasElement>$("#lines")[0];
		var myrainbow = <HTMLCanvasElement>$("#rainbow")[0];
